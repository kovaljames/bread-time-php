                ...
                <section>
                    ...
                    <!--<header>
                        ...
                        <ul class="info post_actions">
                            ...
                            <li><a class="act_view" target="_blank" href="../posts/categoria.php?catid=<?= $sub['category_id']; ?>" title="Ver no site">Ver no site</a></li>
                    ...
                    if (!$readSub->getResult()):
                        ...
                        foreach ($readSub->getResult() as $sub):
                            ...
                            <article<?php if ($a % 3 == 0) echo ' class="right"'; ?>>
                                <h1><a target="_blank" href="../posts/categoria.php?catid=<?= $sub['category_id']; ?>" title="Ver Categoria"><?= $sub['category_title']; ?></a>  ( <?= $readCatPosts->getRowCount(); ?> posts )</h1>
