<div class="content home">
    ...
    <aside>
        ...
        <article class="sitecontent boxaside">
            ...
            //VISITAS DOS POSTS
            $read->FullRead("SELECT SUM(post_views) AS views FROM ws_posts");
...
*/
            ...
            <ul>
                ...
                <li class="view"><span><?= $Views; ?></span> visitas dos posts</li>
            ...
            if ($read->getResult()):
                foreach ($read->getResult() as $re):
                    ...
                    <article>
                        ...
                        <h1><a target="_blank" href="../posts/post.php?id=<?=$post_id;?>" title="Ver Post"><?= Check::Words($post_title, 10) ?></a></h1>
                        <ul class="info post_actions">
                            <li><strong>Data:</strong> <?= date('d/m/Y H:i', strtotime($post_date)); ?>Hs</li>
                            <li><a class="act_view" target="_blank" href="../posts/post.php?id=<?=$post_id;?>" title="Ver no site">Ver no site</a></li>
